...
public class ReevooOverallServiceRatingBadgeTest extends BasicTagTestCaseAdapter {
    ...
    public void testThatIfVariantNamePresentItPrintsTheRightAnchorClass(){
        ...
        processTagLifecycle();
        verifyOutput("<a href=\"http://mark.reevoo.com/retailer/FOO\" class=\"reevoo_reputation undecorated\"></a>");
    }
    ...
    public void testThatTheTagBodyGoesAsTheAnchorBody(){
        setBody("click here");
        processTagLifecycle();
        verifyOutput("<a href=\"http://mark.reevoo.com/retailer/FOO\" class=\"reevoo_reputation\">click here</a>");
    }
}