...
public class ReevooConversationSeriesBadgeTest extends BasicTagTestCaseAdapter {
    ...
    {
        processTagLifecycle();
        verifyOutput("<a class=\"reevoomark reevoo-conversations\" href=\"//test.reevoo.com/partner/FOO/series:ABC123\"></a>");
    }
    ...
    public void testThatIfVariantNamePresentItPrintsTheRightAnchorClass(){
        ...
        processTagLifecycle();
        verifyOutput("<a class=\"reevoomark reevoo-conversations undecorated\" href=\"//test.reevoo.com/partner/FOO/series:ABC123\"></a>");
    }
    ...
    public void testThatTheTagBodyGoesAsTheAnchorBody(){
        setBody("click here");
        processTagLifecycle();
        verifyOutput("<a class=\"reevoomark reevoo-conversations\" href=\"//test.reevoo.com/partner/FOO/series:ABC123\">click here</a>");
    }
}
